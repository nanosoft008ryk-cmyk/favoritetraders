    ...
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 py-20 items-center">
          ...
          <div className="hidden lg:block relative h-[560px] reveal" style={{ animationDelay: "200ms" }}>
            <div className="absolute top-0 right-0 w-72 h-96 rounded-3xl overflow-hidden shadow-luxury animate-float">
              <img src="https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=700&q=80" alt="Denim jacket model" className="w-full h-full object-cover" />
            </div>
            <div className="absolute bottom-0 left-0 w-64 h-80 rounded-3xl overflow-hidden shadow-luxury animate-float-slow" style={{ animationDelay: "1s" }}>
              <img src="https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=700&q=80" alt="Leather jacket model" className="w-full h-full object-cover" />
            </div>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
          {[
            { cat: "mens-denim", title: "Men's Denim", img: "https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=700&q=80" },
            { cat: "womens-denim", title: "Women's Denim", img: "https://images.unsplash.com/photo-1611042553365-9b101441c135?auto=format&fit=crop&w=700&q=80" },
            { cat: "mens-leather", title: "Men's Leather", img: "https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=700&q=80" },
            { cat: "womens-leather", title: "Women's Leather", img: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=700&q=80" },
          ].map((c) => (
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-luxury reveal">
            <img src="https://images.unsplash.com/photo-1604644401890-0bd678c83788?auto=format&fit=crop&w=900&q=80" alt="Brooklyn workshop" className="w-full h-full object-cover" />
